...
a_score=np.load('part2_boxing_a_score.npy')
b_score=np.load( 'part2_boxing_b_score.npy')
length=np.load('part2_boxing_length.npy')
differenct=np.load('part2_boxing_difference_score.npy')
