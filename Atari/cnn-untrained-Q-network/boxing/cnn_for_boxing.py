...
np.save('part2_boxing_a_score', total_score_a)
np.save('part2_boxing_b_score', total_score_b)
np.save('part2_boxing_length', length)
np.save('part2_boxing_difference_score',total_absolute)
