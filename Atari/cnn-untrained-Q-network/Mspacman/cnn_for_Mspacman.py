                ...
                for i_step in range(100000):
                    ...
                    if len(initial_buffer) < 4:
                        ...
                        if np.random.random() <= eplison:
                            action_select=np.random.randint(9)
...
print('the agent scors...',total_score)
print('the frames counts...',length)
print('the std of total-scoe...',std_score)
print('the std of length...',std_length)
print('the mean of total score..',np.mean(total_score, axis=0))
...
np.save('part2_MsPacman_a_score', total_score)

np.save('part2_MsPacman_length', length)
