                ...
                for i_step in range(max_eposide_length):
                    ...
                    if (i_eposide-1)%20==0:
                        ...
                        ### record average test performance ###
                            ...
                            print('ith_run', i_run-1, 'the ith eposide', i_eposide-1, 'the train_length_eposide', i_step + 1,
                            ...
                            if all_test_episode_length[i_run - 1, int((i_eposide - 1) / 20)] == np.amax(
                                ...
                                if not os.path.exists('./part5_neural_1000_300/'):
                                    os.mkdir('./part5_neural_1000_300/')
                                saver.save(sess, "./part5_neural_1000_300/")
                                print('saved')
...
np.save('part_5_train_reward_1000_300', outfile1)
np.save('part5_train_eposide_length_1000_300',outfile2)

np.save('part5_train_loss_1000_300', outfile3)
np.save('part5_test_reward_1000_300', outfile4)
np.save('part5_test_length_1000_300', outfile5)
